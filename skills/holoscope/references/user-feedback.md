---
name: holoscope-user-feedback
description: Wires up user feedback (thumbs up/down, ratings, comments) from an application's frontend to HoloScope scores. Use when user wants to capture end-user feedback, add ratings to traces, or connect user complaints to HoloScope.
metadata:
  required_access:
    - CODEBASE
